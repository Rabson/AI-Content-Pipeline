...
export const env = {
  ...
  internalServiceJwtClockSkewSeconds: readNumber('INTERNAL_SERVICE_JWT_CLOCK_SKEW_SECONDS', 30),
  ...
  mediumApiBaseUrl: readString('MEDIUM_API_BASE_URL', 'https://api.medium.com/v1'),
  linkedinApiBaseUrl: readString('LINKEDIN_API_BASE_URL', 'https://api.linkedin.com'),
  linkedinApiVersion: readString('LINKEDIN_API_VERSION', '202501'),
  ...
  authLockoutThreshold: readNumber('AUTH_LOCKOUT_THRESHOLD', 5),
  authLockoutWindowMs: readNumber('AUTH_LOCKOUT_WINDOW_MS', 15 * 60 * 1000),
  ...
  userTokenEncryptionKeyVersion: readNumber('USER_TOKEN_ENCRYPTION_KEY_VERSION', 1),
} as const;
