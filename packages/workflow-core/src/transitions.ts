...
export const TOPIC_TO_CONTENT_STATE: Partial<Record<TopicStatus, ContentState>> = {
...
export function canTopicTransition(from: TopicStatus, to: TopicStatus): boolean {
...
export function topicToContentState(topicStatus: TopicStatus) {
